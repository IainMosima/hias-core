CREATE TABLE policies (
    ...
    status VARCHAR(20) NOT NULL DEFAULT 'DRAFT' CHECK (status IN ('DRAFT', 'ACTIVE', 'LAPSED', 'TERMINATED')),
...
CREATE TABLE members (
    ...
    relationship VARCHAR(20) NOT NULL CHECK (relationship IN ('principal', 'spouse', 'child', 'parent')),
